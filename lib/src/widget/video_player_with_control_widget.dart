...
class VideoPlayerWithControlWidget extends StatefulWidget {
  const VideoPlayerWithControlWidget({
    Key? key,
    this.controls,
  ...
  @override
  State<StatefulWidget> createState() => _StateVideoPlayerWithControlWidget();
}

class _StateVideoPlayerWithControlWidget
    extends State<VideoPlayerWithControlWidget> {
